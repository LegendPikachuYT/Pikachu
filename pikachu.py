...
if a == "y":
    ...
    print(colored('▄'*int(termsize[0]),color = 'cyan'))
    print("\n")
    ae = Figlet(font='alligator')
    print(colored(ae.renderText('MENU'),color = 'green'))
    print("\n")
    print(colored('''
    [01] HiddenEye\t\t[02] Nmap 
    [03] Tbomb		        [04] Phoneinfoga 
    [05] PhoneInfoga        [06] Anon-SMS 
    ...
    if c == int(6):
        os.chdir('/data/data/com.termux/files/home')
        subprocess.call('pkg install git python -y',shell = True)
        subprocess.call('git clone https://github.com/HACK3RY2J/Anon-SMS.git',shell = True)
    ...
    if c == int(15):
        ...
        subprocess.call('chmod +x ddos.py && python2 ddos.py',shell = True)
    if c == int(16):
        os.chdir('/data/data/com.termux/files/home')
        subprocess.call('pkg install python2 git -y',shell = True)
    ...
    if c == int(18):
        ...
        subprocess.call('gem install bundler',shell = True)
    ...
    if c == int(26):
        os.chdir('/data/data/com.termux/files/home')
        subprocess.call('pkg install git -y',shell = True)
        subprocess.call('git clone https://github.com/mokaddes/Ghost-Droid',shell = True)
        print(colored("[+] Successfully Installed Ghost Droid ",color = 'green'))
        os.chdir('/data/data/com.termux/files/home/Ghost-Droid')
        subprocess.call('chmod 777 setup.sh && bash setup.sh',shell =True)
        subprocess.call('bash ghost-droid',shell = True)
    if c == int(27):
        os.chdir('/data/data/com.termux/files/home')
    ...
    if c == int(29):
        ...
        subprocess.call('pip3 install -r requiremnts.txt',shell = True)
        subprocess.call('pip install requests requests_futures torrequest',shell = True)
    ...
    if c == int(31):
        ...
        os.chdir('/data/data/com.termux/files/home')
        subprocess.call('pip install requests && pip install parse',shell = True)
    ...
    if c == int(40):
        ...
        subprocess.call('pkg install python python2 git -y',shell = True)
        os.chdir('/data/data/com.termux/files/home')
        subprocess.call('git clone https://github.com/fr13nds-group/PhoneSploit',shell = True)
    ...
    if c == int(43):
        os.chdir('/data/data/com.termux/files/home')
        subprocess.call('pkg install git -y',shell = True)
        subprocess.call('git clone https://github.com/termuxprofessor/parrotshell',shell = True)
        os.chdir('/data/data/com.termux/files/home/parrotshell')
        subprocess.call('chmod +x * && bash install.sh',shell = True)
        print(colored('''#TO UNINSTALL PARROT OS SHELL \n USE COMMAND = cd parrotshell \nbash uninstall.sh \n YES''',color = 'red'))
    if c == int(44):
        os.chdir('/data/data/com.termux/files/home')
        subprocess.call('pkg install git -y',shell = True)
        os.chdir('/data/data/com.termux/files/home')
...
Boom! You are done'''))
    ...
    if c == int(50):
        ...
        subprocess.call('pkg install git -y',shell = True)
        os.chdir('/data/data/com.termux/files/home')
        subprocess.call('git clone https://github.com/Lexiie/Termux-Apktool',shell = True)
    ...
    if c == int(51):
        ...
        subprocess.call('bash installmad.sh',shell = True)
        os.chdir('/data/data/com.termux/files/home/WishFish')
        print(colored("#Note - Please Turn On Your Hotspot",color = 'red'))
        subprocess.call('bash madcam.sh',shell = True)
    if c == int(52):
        os.chdir('/data/data/com.termux/files/home')
    ...
    if c == int(53):
        os.system('clear')
        # TODO: Center text starts with "I am glad..."
        t1 = "I am glad that you gave your precious time to know about me!"
        totstr = (" "*(int(int(termsize[0])-(len(t1)/2))))+t1
        print(colored(totstr,color='cyan'))
        print("\n\n")
        ...
        for i in msg2:
             ...
             time.sleep(0.02)
        print('+---------------------------------------------------------+')
        print('|                   AndreyTheHacker here!                 |')
        print('|     I just wanted to help to code this genius tool      |')
        print('|        (Contribute)--------^                            |')
        print('|                                                         |')
        print('|       Telegram/VK: @pikachu_andrey (Russia)             |')
        print('|       DeviantArt: @Hahaha00101 (unnecessary)            |')
        print('+---------------------------------------------------------+')
    if c == int(54):
